 ...
 * @version 1.0.0
 */
public class FruitAdapterVertical extends RecyclerView.Adapter<FruitAdapterVertical.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mImageView = view.findViewById(R.id.image_fruit_vertical);
            mTextView = view.findViewById(R.id.text_fruit_name_vertical);

        }
    }

    public FruitAdapterVertical(List<Fruit> fruitList) {
